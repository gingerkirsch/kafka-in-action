...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public alert_status status;
   ...
   */
  public Alert(java.lang.Long sensor_id, java.lang.Long time, alert_status status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: status = (alert_status)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(alert_status value) {
    this.status = value;
  }
   ...
   */
  public static com.kakfainaction.chapter3.Alert.Builder newBuilder() {
    return new com.kakfainaction.chapter3.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.kakfainaction.chapter3.Alert.Builder newBuilder(com.kakfainaction.chapter3.Alert.Builder other) {
    return new com.kakfainaction.chapter3.Alert.Builder(other);
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.kakfainaction.chapter3.Alert.Builder newBuilder(com.kakfainaction.chapter3.Alert other) {
    return new com.kakfainaction.chapter3.Alert.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kakfainaction.chapter3.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kakfainaction.chapter3.Alert other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.sensor_id)) {
        this.sensor_id = data().deepCopy(fields()[0].schema(), other.sensor_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kakfainaction.chapter3.Alert.Builder setSensorId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kakfainaction.chapter3.Alert.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kakfainaction.chapter3.Alert.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kakfainaction.chapter3.Alert.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kakfainaction.chapter3.Alert.Builder setStatus(alert_status value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kakfainaction.chapter3.Alert.Builder clearStatus() {
      status = null;
    ...
    public Alert build() {
      try {
        ...
        record.status = fieldSetFlags()[2] ? this.status : (alert_status) defaultValue(fields()[2]);
        return record;
